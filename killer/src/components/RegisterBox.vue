<template>
   <div>
      ...
      <input type="password" v-model="form.password2" placeholder="password again" class="form-control"><br>
      <p class="text" align="left">E-mail</p>
      <input type="email" v-model="form.email" placeholder="E-mail" class="form-control">
...
export default {
  ...
  methods: {
    register () {
      this.Error = ''
      if (this.form.username && this.form.password && this.form.password2 && this.form.email) {
